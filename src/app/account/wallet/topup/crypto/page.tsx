      ...
      <section className="mx-auto max-w-xl px-6 pt-32 pb-20">
        ...
        {!invoice && (
          ...
          >
            ...
            >
              {loading ? "Constructing Secure Invoice..." : "Generate Crypto Invoice ⚡"}
            </button>
          </form>
        )}
        ...
        {invoice && (
          <div className="bg-zinc-950 border border-white/10 p-6 rounded-2xl text-center animate-in fade-in zoom-in-95 duration-200">
            <h3 className="font-black text-xl mb-2">Invoice Ready</h3>
            <p className="text-sm text-zinc-400 mb-6">
              You will be redirected to the secure Heleket payment page where you
              can choose Bitcoin, USDT (TRC20 / ERC20 / etc.), Litecoin and more.
            </p>
            ...
            <p className="text-[11px] text-zinc-500">
              Reference: <span className="text-zinc-400 font-mono">{invoice.reference}</span>
            </p>
          </div>
        )}
      </section>
