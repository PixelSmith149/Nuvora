...
export default function MarketingTermsPage() {const t = useTranslations("MarketingTermsOfService");
    ...
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center">
				<div className="flex flex-col items-center gap-3">
					...
					<p className="text-xs text-zinc-500 font-medium">{t("loadingTerms")}</p>
				</div>
			</div>);
			...
			<div className="sticky top-0 z-50 border-b border-white/5 bg-black/80 backdrop-blur-xl">
                ...
                className="text-zinc-400 hover:text-white hover:bg-white/5 rounded-xl text-xs h-9">
						...
						<div className="flex items-center gap-2">
							...
							<span className="text-sm font-bold text-white"> {t("nuvora")} 
			...
			<div className="max-w-4xl mx-auto px-4 py-8">
				<div className="bg-zinc-950/40 border border-white/5 rounded-2xl p-6 shadow-2xl">
					...
					<div className="mb-6 p-4 bg-gradient-to-r from-emerald-900/20 via-zinc-900/20 to-teal-900/20 rounded-xl border border-white/5">
						<h1 className="text-xl font-bold text-white"> {t("welcomeToNuvora")} 
              {displayName}! 👋
						</h1>
						<p className="text-sm text-zinc-400 mt-1"> {t("beforeYouStartSellingOn")}
              {" "}
							<span className="text-emerald-400 font-medium">{t("eliteHome")}</span>{t("pleaseReviewAndAcceptOur")} 
              ...
              isLoading={isSubmitting} />
					...
					<div className="mt-6 pt-4 border-t border-white/5 text-center">
						<p className="text-[10px] text-zinc-600"> {t("nuvoraEliteHomeSecureDigital")} 
