		...
		<div className="min-h-screen bg-black text-white relative luxury-gradient">
			...
			<section className="relative z-30 pt-32 pb-20 px-6">
				<div className="max-w-7xl mx-auto relative">
					...
					{/* Notification Bell */}
					{userId && (
						<div className="absolute top-1/2 right-6 -translate-y-1/2 z-[9999]">
							<div className="group relative animate-[float_3.5s_ease-in-out_infinite]">
								{/* Glow */}
								...
								{/* Glass Card */}
								<div className="relative flex h-16 w-16 items-center justify-center rounded-2xl border border-amber-400/25 bg-zinc-950/85 backdrop-blur-xl shadow-[0_0_40px_rgba(251,191,36,0.12)] transition-all duration-300 group-hover:scale-110 group-hover:border-amber-400/60 group-hover:shadow-[0_0_60px_rgba(251,191,36,0.25)]">
									<NotificationBell />
								</div>
								...
								<span className="absolute -top-1 -right-1 flex h-4 w-4">
									...
									<span className="relative inline-flex h-4 w-4 rounded-full bg-amber-400 border border-black" />
								</span>
							</div>
						</div>
					)}
						...
						<div className="card-hover h-full rounded-3xl overflow-hidden border border-white/10 bg-zinc-950/80 hover:border-amber-400/30 transition-all duration-500 backdrop-blur-xl">
							...
							<div className="p-10">
								...
								<p className="text-gray-400 text-[17px] leading-relaxed">
									Premium SMM Panel — Boost all kinds of social media accounts
									and pages. Grow followers, engagement, views, and reach with
									powerful, secure tools.
								</p>
					...
					<Link href="/m/global-market" className="group">
						<div className="card-hover h-full rounded-3xl overflow-hidden border border-white/10 bg-zinc-950/80 hover:border-amber-400/30 transition-all duration-500 backdrop-blur-xl">
							...
							<div className="p-10">
								...
								<p className="text-gray-400 text-[17px] leading-relaxed">
									International marketplace for digital assets, tools, and
									social media accounts. Create storefronts, list products, and
					...
					<Link href="/social-tenant" className="group">
						<div className="card-hover h-full rounded-3xl overflow-hidden border border-white/10 bg-zinc-950/80 hover:border-amber-400/30 transition-all duration-500 backdrop-blur-xl">
							...
							<div className="p-10">
								...
								<p className="text-gray-400 text-[17px] leading-relaxed">
									Own and customize stunning link-in-bio websites and branded
									domain sites with one tap. Professional digital presence made
									effortless.
								</p>
								<div className="mt-8 inline-flex items-center text-amber-400 font-medium group-hover:gap-3 transition-all">
									Enter Tenant Web
