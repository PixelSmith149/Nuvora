...
export function BlogsPage({
    ...
    const categories = [
        { id: "platform", label: "Platform", icon: <Sparkles className="h-4 w-4" /> },
        { id: "global-market", label: "Global Market", icon: <Package className="h-4 w-4" /> },
        { id: "smm-panel", label: "SMM Panel", icon: <Users className="h-4 w-4" /> },
        { id: "social-tenant", label: "Social Tenant", icon: <Building2 className="h-4 w-4" /> },
    ];
    ...
    const getCategoryColor = (category: string) => {
        ...
        return colors[category] || "text-zinc-400 bg-zinc-800/50 border-zinc-700/50";
    };
            ...
            <div className="min-h-screen bg-black text-white">
                <div className="max-w-4xl mx-auto px-4 py-8">
                    ...
                    <article className="space-y-6">
                        <span
                            className={`inline-flex items-center gap-1.5 text-xs font-bold px-3 py-1 rounded-full border ${getCategoryColor(
                        ...
                        <div className="prose prose-invert max-w-none space-y-4">
                            ...
                            <div className="text-zinc-400 leading-relaxed whitespace-pre-line">
                                {selectedPost.content || "No detailed content provided for this post yet."}
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {paginatedPosts.map((post) => (
                            ...
                            >
                                ...
                                <div className="p-4">
                                    <span
                                        className={`inline-flex items-center gap-1 text-[10px] font-bold px-2 py-0.5 rounded-full border ${getCategoryColor(
                                            post.category
                                        )}`}
                                    >
