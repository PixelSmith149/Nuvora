...
export function SupportPage() {const t = useTranslations("Support");
  ...
  <div className="space-y-6">
			<div className="text-center space-y-3">
				<div className="flex items-center justify-center gap-3">
					...
					<div>
						<h1 className="text-2xl font-bold text-white"> {t("howCanWeHelpYou")} 

          </h1>
						<p className="text-sm text-zinc-400"> {t("selectTheAreaYouNeed")} 
        ...
        <div className="space-y-4">
              ...
              className="p-2 rounded-lg hover:bg-white/5 transition-colors">
					...
					<div className="p-4 rounded-xl border border-emerald-500/20 bg-emerald-500/5">
						...
						<h3 className="text-base font-bold text-white text-center"> {t("troubleshootingComplete")} 
            ...
            <p className="text-sm text-zinc-400 text-center mt-2">
						...
						<p className="text-xs text-zinc-500 text-center mt-4"> {t("ifYoureStillExperiencingIssues")} 
    ...
    return (
      <div className="space-y-4">
            ...
            className="p-2 rounded-lg hover:bg-white/5 transition-colors">
					...
					<div>
						<h2 className="text-sm font-bold text-white">{t("troubleshooting")}</h2>
						<p className="text-xs text-zinc-500"> {t("step")} 
  ...
  <div className="space-y-4">
        ...
        className="p-2 rounded-lg hover:bg-white/5 transition-colors">
			...
			<div className="p-4 rounded-xl border border-red-500/20 bg-red-500/5">
				...
				<h3 className="text-base font-bold text-white text-center"> {t("ThisRequiresImmediateAttention")} 

      </h3>
				<p className="text-sm text-zinc-400 text-center mt-2">{reason}</p>
				<p className="text-xs text-zinc-500 text-center mt-4"> {t("ourSupportTeamWillPrioritize")} 
    ...
    return (
      <div className="space-y-4">
            ...
            className="p-2 rounded-lg hover:bg-white/5 transition-colors">
					...
					<div>
						<h2 className="text-sm font-bold text-white"> {t("createSupportTicket")} 

            </h2>
						<p className="text-xs text-zinc-500"> {t("wellGetBackToYou")} 
				...
				<div className="p-4 rounded-xl border border-white/5 bg-zinc-950/30 space-y-4">
					<div className="text-xs text-zinc-500 space-y-1">
						<p>
							<span className="text-white">{t("category")}</span> {phaseLabel}
						</p>
						<p>
							<span className="text-white">{t("issue")}</span> {subTopic?.label}
						</p>
					</div>

					<div>
						<label className="text-xs font-bold text-zinc-400 mb-1.5 block"> {t("emailAddress")} 
              ...
              className="bg-black border-white/10 text-white rounded-xl" />
					...
					<div>
						<label className="text-xs font-bold text-zinc-400 mb-1.5 block"> {t("subject")} 
              ...
              className="bg-black border-white/10 text-white rounded-xl" />
					...
					<div>
						<label className="text-xs font-bold text-zinc-400 mb-1.5 block"> {t("description")} 
              ...
              className="bg-black border-white/10 text-white rounded-xl resize-none" />
					...
					<div>
						<label className="text-xs font-bold text-zinc-400 mb-1.5 block"> {t("priority")} 
              ...
              <button
                ...
                "border-white/10 text-zinc-500 hover:border-white/20"}`
					...
					<div>
						<label className="text-xs font-bold text-zinc-400 mb-1.5 block"> {t("screenshotsOptional")} 
  ...
  <div className="space-y-4">
			<div className="text-center py-8">
				...
				<p className="text-sm text-zinc-400 mt-2"> {t("yourSupportTicketHasBeen")} 

      </p>
				<p className="text-xs text-zinc-500 mt-1"> {t("wellRespondWithin24Hours")} 
			...
			<div className="p-4 rounded-xl border border-white/5 bg-zinc-950/30 space-y-1">
				...
				<p className="text-xs text-zinc-500">
					<span className="text-white">{t("priority_1")}</span>{" "}
        ...
        className="flex-1 bg-zinc-900/50 border border-white/10 hover:bg-zinc-800 text-white rounded-xl p-3 text-xs font-bold transition-all"> {t("returnHome")} 


      </button>
				<button
        onClick={() => window.location.href = "/support"}
        className="flex-1 bg-emerald-500/10 border border-emerald-500/20 hover:bg-emerald-500/20 text-white rounded-xl p-3 text-xs font-bold transition-all"> {t("backToSupport")} 
          ...
          <>
            ...
            renderConfirmation(currentStep.data)}
					...
					<div className="mt-6 pt-4 border-t border-white/5 text-center">
						<p className="text-[10px] text-zinc-600"> {t("needImmediateHelp")}
              {" "}
							<span className="text-emerald-400">{t("liveChat")}</span> {t("available247")} 
              <br /> {t("orEmailUsAt")}
              {" "}
							<a
